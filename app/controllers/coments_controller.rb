class ComentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coment.save
        format.html { redirect_to @coment.post, notice: 'Coment was successfully created.' }
        else
        format.html { redirect_to @coment.post, notice: 'Coment wasn\'t successfully created.' }
        end
    end
  end
  ...
  private
    ...
    def coment_params
      params.require(:coment).permit(:name, :email, :body, :post_id)
    end
end
