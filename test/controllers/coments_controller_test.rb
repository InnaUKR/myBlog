...
class ComentsControllerTest < ActionController::TestCase
  ...
  test "should create coment" do
    assert_difference('Coment.count') do
      post :create, coment: { body: @coment.body, email: @coment.email, name: @coment.name, post_id: @coment.post_id }
    end
  ...
  test "should update coment" do
    patch :update, id: @coment, coment: { body: @coment.body, email: @coment.email, name: @coment.name, post_id: @coment.post_id }
    assert_redirected_to coment_path(assigns(:coment))
  end
